      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 order-md-last ftco-animate">
            <h2 class="mb-3">Equipe de desenvolvedores</h2>
            <p>A equipe de desenvolvedores da Wush se esforça para realizar o melhor trabalho, e isso pode ser visto em nossa aplicação.</p>
            <p>
              <img src="images/Foto (2).jpg" alt="" class="img-fluid">
            </p>
            <p>A Wush conta com uma equipe de desenvolvedores qualificados e dispostos a contribuir para o sucesso dessa ideia, que traz uma revolução para o nicho. Esses apoiadores são totalmente capazes de gerenciar o sistema, assim como também administrar para que todos tenham uma ótima experiência dentro de nossos serviços. Com isso em mãos a Wush se empenha todos dias para arrecadar o melhor dela, trazendo assim os melhores resultados para seu utilizadores. Agradecemos a todos por utilizar de nossos serviços.</p>
